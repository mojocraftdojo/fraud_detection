...
Other than these, an Artificial Neural Network (ANNs) model is also trained to compare with the above traditional ML models. The ANN model is built using Keras/Tensorflow 2.0 framework. 
